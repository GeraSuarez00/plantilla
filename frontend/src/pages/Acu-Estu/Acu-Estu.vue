          ...
          <div class="col-12">
            <card class="strpied-tabled-with-hover"
              ...
              <template slot="header">
                ...
                <h4 class="card-title">Listado de Acudientes - Estudiantes</h4>
                </div>
                <div class="col-xl-3 col-md-3">
                  <b-button to="/admin/create-ae" size="sm" variant="danger">Agregar</b-button>
                </div>
              </div> 
              </template>
               ...
               <thead class="table-danger">
                ...
                <tbody v-for="dato in datos" :key="dato.id">
                  <tr  class="table-ligth">
                    <td>{{dato.id}}</td>
                    <td>{{dato.sa_stu_id.nombre}} {{dato.sa_stu_id.apellidos}}, {{dato.sa_stu_id.identificación}}</td>
                    <td>{{dato.sa_att_id.nombre}} {{dato.sa_att_id.apellidos}}, {{dato.sa_att_id.identificación}}</td>
          ...
          Swal.fire({
                    ...
                    reverseButtons: true
                      ...
                      if (result.isConfirmed) {
                        ...
                        axios.delete("http://127.0.0.1:8000/api/Student_Attendant/" + id + "/").then(result => {
                        // console.log(result);
                        })
